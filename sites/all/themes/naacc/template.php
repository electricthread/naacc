...
function naacc_preprocess_page(&$vars,$hook) {
  ...
  // Google Fonts
  drupal_add_css('https://fonts.googleapis.com/css?family=Esteban','external');
  drupal_add_css('https://fonts.googleapis.com/css?family=Lato:300,400,700,900','external');
