...
function nexus_preprocess_page(&$vars) {
  ...
  if ($vars['theme_hook_suggestions'][0] == 'page__user') {
    // If First Name field is present (both first and last are required)
    if (isset($vars['page']['content']['system_main']['field_first_name'])) {
      $name = $vars['page']['content']['system_main']['field_first_name']['#object']->field_first_name['und'][0]['safe_value'] . ' ' . $vars['page']['content']['system_main']['field_last_name']['#object']->field_last_name['und'][0]['safe_value'];
