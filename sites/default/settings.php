 ...
 *
 */
$drupal_hash_salt = 'VagxgAOziwCtCGR_kBRTFvTqrEglbwEPBejpAoiK21A';
...
if (isset($_SERVER['PANTHEON_ENVIRONMENT']) &&
  ...
  if ($_SERVER['HTTP_HOST'] == 'www.tennmediators.org' ||
      $_SERVER['HTTP_HOST'] == 'live-tapm.gotpantheon.com') {
    header('HTTP/1.0 301 Moved Permanently');
    header('Location: http://tennmediators.org'. $_SERVER['REQUEST_URI']);
    exit();
  }
}
